...
ifeq ($(qemu),true)
	@cp -fp $(TARGET_PREBUILT_KERNEL) $(BALONG_TOPDIR)/build/delivery/$(TARGET_BOARD_PLATFORM)/image/
	@cp -fp $(KERNEL_OUT)/vmlinux $(BALONG_TOPDIR)/build/delivery/$(TARGET_BOARD_PLATFORM)/image/
endif
