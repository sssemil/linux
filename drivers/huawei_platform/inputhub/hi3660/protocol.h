...
typedef enum {
	...
	CMD_ENVIRONMENT_START_REQ,
	CMD_ENVIRONMENT_START_RESP,
	CMD_ENVIRONMENT_STOP_REQ,
	CMD_ENVIRONMENT_STOP_RESP,
	CMD_ENVIRONMENT_FLUSH_REQ = 0x27,
	CMD_ENVIRONMENT_FLUSH_RESP,
	CMD_ENVIRONMENT_GET_STATE_REQ = 0x2b,
	CMD_ENVIRONMENT_GET_STATE_RESP,
	CMD_ENVIRONMENT_START_CELLINFO_REQ,
	CMD_ENVIRONMENT_START_CELLINFO_RESP,
	CMD_ENVIRONMENT_STOP_CELLINFO_REQ,
	CMD_ENVIRONMENT_STOP_CELLINFO_RESP,
	CMD_ENVIRONMENT_AP_GET_CELLINFO_REQ,
	CMD_ENVIRONMENT_AP_GET_CELLINFO_RESP,
