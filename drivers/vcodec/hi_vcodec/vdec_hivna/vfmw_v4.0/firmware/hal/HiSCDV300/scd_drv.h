...
#define REG_SCD_INT_FLAG               (0x840)
#define REG_SCD_PREVIOUS_BYTE_MSB      (0x844)
#define REG_SCD_BYTE_VALID             (0x848)
...
#define REG_SCD_SAFE_INT_MASK          (0x8c4)
#define REG_SCD_SAFE_INI_CLR           (0x8c8)
...
typedef struct {
	...
	SINT32   reg_avs_flag;
	UINT32   ScdPreviousByteMsb;
	UINT32   ScdPreviousByteLsb;
...
typedef struct
{
    ...
    HI_S32 SrcEaten;
    HI_S32 UpLen;
    HI_U32 ScdPreviousByteMsb;
    HI_U32 ScdPreviousByteLsb;
    HI_U32 ScdByteValid;
    HI_U32   SegNextAddr;
}SCD_STATE_REG_S;
