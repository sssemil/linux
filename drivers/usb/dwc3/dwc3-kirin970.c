...
const uint32_t PMU_VBUS_REG_DEFAULT_ADDR = 0x6;
const uint32_t PMU_VBUS_REG_DEFAULT_OFFSET = 0x1;

/* clk freq usb default 228 */
...
int usb31phy_cr_ack_wait_n = 10000;
