...
struct noc_mid_info noc_mid_kirin970[] = {
	...
	{0, 11, 0x003f, 0x24, "DFC"},  /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x16, "CIPHER"},  /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x36, "HDLC"},  /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x17, "CICOM0"},  /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x37, "CICOM1"},  /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x18, "BBE16_0"},  /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x38, "BBE16_C"},  /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x19, "BBP_DMA_0"},/*noc_modem_mst,*/
	{0, 11, 0x003f, 0x39, "BBP_DMA_1"},/*noc_modem_mst,*/
	{0, 11, 0x003f, 0x1A, "GU_BBP_MST_0"},    /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x3A, "GU_BBP_MST_1"},    /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x1B, "EDMA0"},  /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x3B, "EDMA1"},  /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x1C, "HARQ_L"},    /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x3C, "HARQ_H"},    /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x1D, "UPACC"}, /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x3D, "RSR_ACC"}, /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x1E, "CIPHER_WRITE_THOUGH"},   /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x3F, "CCPU_CFG"},   /*noc_modem_mst,*/
	{0, 11, 0x003f, 0x1F, "CCPU_L2C"},   /*noc_modem_mst,*/
};
