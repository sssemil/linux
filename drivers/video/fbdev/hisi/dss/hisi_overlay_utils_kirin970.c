	...
	char __iomem *post_scf_base, dss_arsr1p_t *s_post_scf)
{
	...
	outp32(post_scf_base + ARSR_POST_IHLEFT, s_post_scf->ihleft);
	outp32(post_scf_base + ARSR_POST_IHRIGHT, s_post_scf->ihright);
	outp32(post_scf_base + ARSR_POST_IHLEFT1, s_post_scf->ihleft1);
	outp32(post_scf_base + ARSR_POST_IHRIGHT1, s_post_scf->ihright1);
	outp32(post_scf_base + ARSR_POST_IVTOP, s_post_scf->ivtop);
	outp32(post_scf_base + ARSR_POST_IVBOTTOM, s_post_scf->ivbottom);
	outp32(post_scf_base + ARSR_POST_UV_OFFSET, s_post_scf->uv_offset);
	outp32(post_scf_base + ARSR_POST_IHINC, s_post_scf->ihinc);
	outp32(post_scf_base + ARSR_POST_IVINC, s_post_scf->ivinc);
	outp32(post_scf_base + ARSR_POST_MODE, s_post_scf->mode);
	outp32(post_scf_base + ARSR_POST_FORMAT, s_post_scf->format);

	if (g_dss_version_tag == FB_ACCEL_KIRIN970_ES){
		outp32(post_scf_base + ARSR1P_SKIN_THRES_Y_ES, s_post_scf->skin_thres_y);
		outp32(post_scf_base + ARSR1P_SKIN_THRES_U_ES, s_post_scf->skin_thres_u);
		outp32(post_scf_base + ARSR1P_SKIN_THRES_V_ES, s_post_scf->skin_thres_v);
		outp32(post_scf_base + ARSR1P_SKIN_EXPECTED_ES, s_post_scf->skin_expected);
		outp32(post_scf_base + ARSR1P_SKIN_CFG_ES, s_post_scf->skin_cfg);
		outp32(post_scf_base + ARSR1P_SHOOT_CFG1_ES, s_post_scf->shoot_cfg1);
		outp32(post_scf_base + ARSR1P_SHOOT_CFG2_ES, s_post_scf->shoot_cfg2);
		outp32(post_scf_base + ARSR1P_SHARP_CFG1_ES, s_post_scf->sharp_cfg1);
		outp32(post_scf_base + ARSR1P_SHARP_CFG2_ES, s_post_scf->sharp_cfg2);
		outp32(post_scf_base + ARSR1P_SHARP_CFG3_ES, s_post_scf->sharp_cfg3);
		outp32(post_scf_base + ARSR1P_SHARP_CFG4_ES, s_post_scf->sharp_cfg4);
		outp32(post_scf_base + ARSR1P_SHARP_CFG5_ES, s_post_scf->sharp_cfg5);
		outp32(post_scf_base + ARSR1P_SHARP_CFG6_ES, s_post_scf->sharp_cfg6);
		outp32(post_scf_base + ARSR1P_SHARP_CFG7_ES, s_post_scf->sharp_cfg7);
		outp32(post_scf_base + ARSR1P_SHARP_CFG8_ES, s_post_scf->sharp_cfg8);
		outp32(post_scf_base + ARSR1P_SHARP_CFG9_ES, s_post_scf->sharp_cfg9);
		outp32(post_scf_base + ARSR1P_SHARP_CFG10_ES, s_post_scf->sharp_cfg10);
		outp32(post_scf_base + ARSR1P_SHARP_CFG11_ES, s_post_scf->sharp_cfg11);
		outp32(post_scf_base + ARSR1P_DIFF_CTRL_ES, s_post_scf->diff_ctrl);
		outp32(post_scf_base + ARSR1P_LSC_CFG1_ES, s_post_scf->lsc_cfg1);
		outp32(post_scf_base + ARSR1P_LSC_CFG2_ES, s_post_scf->lsc_cfg2);
		outp32(post_scf_base + ARSR1P_LSC_CFG3_ES, s_post_scf->lsc_cfg3);
		outp32(post_scf_base + ARSR1P_FORCE_CLK_ON_CFG_ES, s_post_scf->force_clk_on_cfg);
	} else {
		outp32(post_scf_base + ARSR_POST_SKIN_THRES_Y, s_post_scf->skin_thres_y);
		outp32(post_scf_base + ARSR_POST_SKIN_THRES_U, s_post_scf->skin_thres_u);
		outp32(post_scf_base + ARSR_POST_SKIN_THRES_V, s_post_scf->skin_thres_v);
		outp32(post_scf_base + ARSR_POST_SKIN_EXPECTED, s_post_scf->skin_expected);
		outp32(post_scf_base + ARSR_POST_SKIN_CFG, s_post_scf->skin_cfg);
		outp32(post_scf_base + ARSR_POST_SHOOT_CFG1, s_post_scf->shoot_cfg1);
		outp32(post_scf_base + ARSR_POST_SHOOT_CFG2, s_post_scf->shoot_cfg2);
		outp32(post_scf_base + ARSR_POST_SHOOT_CFG3, s_post_scf->shoot_cfg3);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG1_H, s_post_scf->sharp_cfg1_h);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG1_L, s_post_scf->sharp_cfg1_l);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG2_H, s_post_scf->sharp_cfg2_h);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG2_L, s_post_scf->sharp_cfg2_l);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG3, s_post_scf->sharp_cfg3);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG4, s_post_scf->sharp_cfg4);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG5, s_post_scf->sharp_cfg5);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG6, s_post_scf->sharp_cfg6);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG6_CUT, s_post_scf->sharp_cfg6_cut);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG7, s_post_scf->sharp_cfg7);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG7_RATIO, s_post_scf->sharp_cfg7_ratio);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG8, s_post_scf->sharp_cfg8);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG9, s_post_scf->sharp_cfg9);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG10, s_post_scf->sharp_cfg10);
		outp32(post_scf_base + ARSR_POST_SHARP_CFG11, s_post_scf->sharp_cfg11);
		outp32(post_scf_base + ARSR_POST_DIFF_CTRL, s_post_scf->diff_ctrl);
		outp32(post_scf_base + ARSR_POST_SKIN_SLOP_Y, s_post_scf->skin_slop_y);
		outp32(post_scf_base + ARSR_POST_SKIN_SLOP_U, s_post_scf->skin_slop_u);
		outp32(post_scf_base + ARSR_POST_SKIN_SLOP_V, s_post_scf->skin_slop_v);
		outp32(post_scf_base + ARSR_POST_FORCE_CLK_ON_CFG, s_post_scf->force_clk_on_cfg);
	}
}
