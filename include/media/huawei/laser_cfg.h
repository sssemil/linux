...
#define HWLASER_PRESETMODE_SINGLE_MODE               ((HWLASER_PresetModes)  5)
#define HWLASER_PRESETMODE_CONTINUOUS_MODE           ((HWLASER_PresetModes)  6)
#define HWLASER_PRESETMODE_CONTINUOUS_TIMED_MODE     ((HWLASER_PresetModes)  7)

#define HWLASER_PRESETMODE_OLT                       ((HWLASER_PresetModes)  8)
