...
const unsigned short E901006002[5]
	 = {164, 228, 4, 164, 164};
const struct imonitor_event_index Reliability_events[41]
	= { {901000000, E901000000, 4}, {901000001, E901000001, 4},
		...
		{901004003, E901004003, 3}, {901005000, E901005000, 8},
...
const unsigned short E903001015[14]
	 = {6, 6, 180, 356, 180, 196, 180, 356, 228, 180,
		180, 180, 180, 180};
...
const unsigned short E903001024[12]
	 = {6, 6, 356, 356, 356, 356, 900, 900, 356, 356,
		356, 356};
...
const unsigned short E903009000[64]
	 = {2, 2, 2, 3, 3, 3, 3, 2, 3, 3,
		...
		2, 2, 2, 2, 3, 3, 3, 3, 3, 3,
		3, 3, 3, 3};
const struct imonitor_event_index PowerThermal_events[41]
...
const unsigned short E928009000[5]
	 = {4, 164, 164, 1124, 4};
const unsigned short E930001001[64]
	 = {2, 2, 2, 3, 3, 3, 3, 2, 3, 3,
		4, 4, 6, 6, 6, 6, 6, 6, 6, 4,
		2, 2, 2, 2, 2, 3, 3, 3, 3, 3,
		3, 3, 2, 2, 2, 2, 3, 3, 3, 3,
...
const unsigned short E932020100[4]
	 = {3, 5, 4, 4};
const struct imonitor_event_index DMD_events[771]
	= { {920001003, E920001003, 5}, {920001004, E920001004, 5},
		...
		{921001032, E921001032, 5}, {921002000, E921002000, 5},
		...
		{926003006, E926003006, 5}, {926004000, E926004000, 5},
		...
		{930001001, E930001001, 64}, {930001002, E930001002, 39},
...
const unsigned short E907117001[2]
	 = {4, 228};
const struct imonitor_event_index Application_events[235]
...
const unsigned short E908003001[2]
	 = {4, 150};
const struct imonitor_event_index LogEngine_events[14]
...
const struct imonitor_module_index imonitor_modules_table[18] = {
	{Reliability_events, 901000000, 901999999, 41},
	{Performance_events, 902000000, 902999999, 43},
	{PowerThermal_events, 903000000, 903999999, 41},
	{CHR_events, 904000000, 904999999, 13},
	{DMD_events, 920000000, 939999999, 771},
	{Application_events, 907000000, 907999999, 235},
	{LogEngine_events, 908000000, 908999999, 14},
