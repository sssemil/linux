...
#elif defined CONFIG_HISI_PARTITION_KIRIN970 || defined CONFIG_HISI_PARTITION_KIRIN660
static const struct partition partition_table_emmc[] =
{
  {PART_XLOADER_A,        0,         2*1024,        EMMC_BOOT_MAJOR_PART},
  {PART_XLOADER_B,        0,         2*1024,        EMMC_BOOT_BACKUP_PART},
  ...
  {PART_MODEMNVM_IMG,     184*1024,  20*1024,       EMMC_USER_PART},/* modemnvm img    20M    p14*/
  {PART_MODEMNVM_SYSTEM,  204*1024,  16*1024,        EMMC_USER_PART},/* modemnvm system 16M     p15*/
  {PART_SPLASH2,          220*1024,  80*1024,       EMMC_USER_PART},/* splash2         80M    p16*/
  {PART_CACHE,            300*1024,  256*1024,        EMMC_USER_PART},/* cache           256M     p17*/
  {PART_BOOTFAIL_INFO,    556*1024,  2*1024,        EMMC_USER_PART},/* bootfail info   2MB    p18*/
  {PART_MISC,             558*1024,  2*1024,        EMMC_USER_PART},/* misc            2M     p19*/
  {PART_HISEE_ENCOS,        560*1024,  4*1024,       EMMC_USER_PART},/* hisee_encos       4M    p20*/
  {PART_RESERVED2,        564*1024,  28*1024,       EMMC_USER_PART},/* reserved2       32M    p21*/
  {PART_HHEE,        592*1024,  4*1024,        EMMC_USER_PART},/* PART_RESERVED10       4M     p22*/
  {PART_HISEE_FS,         596*1024,  8*1024,        EMMC_USER_PART},/* hisee_fs        8M     p23*/
  {PART_DFX,              604*1024,  16*1024,       EMMC_USER_PART},/* dfx             16M    p24*/
  {PART_RRECORD,          620*1024,  16*1024,       EMMC_USER_PART},/* rrecord         16M    p25*/
  {PART_FW_LPM3_A,        636*1024,  256,           EMMC_USER_PART},/* mcuimage        256K   p26*/
  {PART_RESERVED3_A,      651520,    3840,          EMMC_USER_PART},/* reserved3A      3840KB p27*/
  {PART_HISEE_IMG_A,      640*1024,    4*1024,          EMMC_USER_PART},/* part_hisee_img_a   4*1024KB p28*/
  {PART_FASTBOOT_A,       644*1024,  12*1024,       EMMC_USER_PART},/* fastboot        12M    p29*/
  {PART_VECTOR_A,         656*1024,  4*1024,        EMMC_USER_PART},/* avs vector      4M     p30*/
  {PART_ISP_BOOT_A,       660*1024,  2*1024,        EMMC_USER_PART},/* isp_boot        2M     p31*/
  {PART_ISP_FIRMWARE_A,   662*1024,  14*1024,       EMMC_USER_PART},/* isp_firmware    14M    p32*/
  {PART_FW_HIFI_A,        676*1024,  12*1024,       EMMC_USER_PART},/* hifi            12M    p33*/
  {PART_TEEOS_A,          688*1024,  8*1024,        EMMC_USER_PART},/* teeos           8M     p34*/
  {PART_RECOVERY2_A,      696*1024,  64*1024,       EMMC_USER_PART},/* recovery2       64M    p35*/
  {PART_SENSORHUB_A,      760*1024,  16*1024,       EMMC_USER_PART},/* sensorhub       16M    p36*/
  {PART_BOOT_A,           776*1024,  32*1024,       EMMC_USER_PART},/* boot            32M    p37*/
  {PART_RECOVERY_A,       808*1024,  64*1024,       EMMC_USER_PART},/* recovery        64M    p38*/
  {PART_DTS_A,            872*1024,  16*1024,       EMMC_USER_PART},/* dtimage         16M    p39*/
  {PART_TRUSTFIRMWARE_A,  888*1024,  2*1024,        EMMC_USER_PART},/* trustfirmware   2M     p40*/
  {PART_MODEM_FW_A,       890*1024,  56*1024,       EMMC_USER_PART},/* modem_fw        56M    p41*/
  {PART_RESERVED4_A,      946*1024,  4*1024,       EMMC_USER_PART},/* reserved4A      4M    p42*/
  {PART_HDCP_A,      950*1024,  1*1024,       EMMC_USER_PART},/* PART_HDCP_A      1M    p43*/
  {PART_DDR_PARA_A,      951*1024,  1*1024,       EMMC_USER_PART},/* DDR_PARA      1M    p44*/
  {PART_MODEMNVM_UPDATE_A,952*1024,  16*1024,       EMMC_USER_PART},/* modemnvm update 16M    p45*/
  {PART_MODEMNVM_CUST_A,968*1024,  64*1024,       EMMC_USER_PART},/* modemnvm update cust 64M    p46*/
  {PART_PATCH_A,          1032 *1024,  32*1024,       EMMC_USER_PART},/* patch           16M    p47*/
  {PART_VERSION_A,        1064*1024,  24*1024,        EMMC_USER_PART},/* version         8M     p48*/
  {PART_VENDOR_A,         1088*1024,  784*1024,      EMMC_USER_PART},/* vendor          704M   p49*/
  {PART_PRODUCT_A,        1872*1024, 192*1024,      EMMC_USER_PART},/* product         240M   p50*/
  {PART_CUST_A,           2064*1024, 192*1024,      EMMC_USER_PART},/* cust            256M   p51*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         2256*1024, 3552*1024,     EMMC_USER_PART},/* system          3697M  p52*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        5808*1024, 128*1024,       EMMC_USER_PART},/* reserved5       128M    p53*/
  {PART_HIBENCH_DATA,   5936*1024, 512*1024,       EMMC_USER_PART},/* hibench_data       512M    p54*/
  {PART_USERDATA,         6448*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G     p55*/
  #else
  {PART_USERDATA,         5808*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G     p53*/
  #endif
  #else
  {PART_SYSTEM_A,         2256*1024, 4688*1024,     EMMC_USER_PART},/* system          4000M  p52*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        6944*1024, 128*1024,       EMMC_USER_PART},/* reserved5       64M    p53*/
  {PART_HIBENCH_DATA,   7072*1024, 512*1024,       EMMC_USER_PART},/* hibench_data       512M    p54*/
  {PART_USERDATA,         7584*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G    p55*/
  #else
  {PART_USERDATA,         6944*1024, (4UL)*1024*1024,EMMC_USER_PART},/* userdata       4G    p53*/
  #endif
  #endif
  {"0", 0, 0, 0},                                        /* total 11848M*/
};
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_MODEMNVM_IMG,     176*1024,  20*1024,       UFS_PART_3},/* modemnvm img    20M    p10*/
  {PART_MODEMNVM_SYSTEM,  196*1024,  16*1024,        UFS_PART_3},/* modemnvm system 16M     p11*/
  {PART_SPLASH2,          212*1024,  80*1024,       UFS_PART_3},/* splash2         80M    p12*/
  {PART_CACHE,            292*1024,  256*1024,        UFS_PART_3},/* cache           8M     p13*/
  {PART_BOOTFAIL_INFO,    548*1024,  2*1024,        UFS_PART_3},/* bootfail info   2MB    p14*/
  {PART_MISC,             550*1024,  2*1024,        UFS_PART_3},/* misc            2M     p15*/
  {PART_HISEE_ENCOS,        552*1024,  4*1024,       UFS_PART_3},/* hisee_encos       4M    p16*/
  {PART_RESERVED2,        556*1024,  28*1024,       UFS_PART_3},/* reserved2       32M    p17*/
  {PART_HHEE,        584*1024,  4*1024,        UFS_PART_3},/* PART_RESERVED10       4M     p18*/
  {PART_HISEE_FS,         588*1024,  8*1024,        UFS_PART_3},/* hisee_fs        8M     p19*/
  {PART_DFX,              596*1024,  16*1024,       UFS_PART_3},/* dfx             16M    p20*/
  {PART_RRECORD,          612*1024,  16*1024,       UFS_PART_3},/* rrecord         16M    p21*/
  {PART_FW_LPM3_A,        628*1024,  256,           UFS_PART_3},/* mcuimage        256K   p22*/
  {PART_RESERVED3_A,      643328,    3840,          UFS_PART_3},/*reserved3A      3840KB  p23*/
  {PART_HISEE_IMG_A,      632*1024,    4*1024,          UFS_PART_3},/*part_hisee_img_a   4*1024KB  p24*/
  {PART_FASTBOOT_A,       636*1024,  12*1024,       UFS_PART_3},/* fastboot        12M    p25*/
  {PART_VECTOR_A,         648*1024,  4*1024,        UFS_PART_3},/* avs vector      4M     p26*/
  {PART_ISP_BOOT_A,       652*1024,  2*1024,        UFS_PART_3},/* isp_boot        2M     p27*/
  {PART_ISP_FIRMWARE_A,   654*1024,  14*1024,       UFS_PART_3},/* isp_firmware    14M    p28*/
  {PART_FW_HIFI_A,        668*1024,  12*1024,       UFS_PART_3},/* hifi            12M    p29*/
  {PART_TEEOS_A,          680*1024,  8*1024,        UFS_PART_3},/* teeos           8M     p30*/
  {PART_RECOVERY2_A,      688*1024,  64*1024,       UFS_PART_3},/* recovery2       64M    p31*/
  {PART_SENSORHUB_A,      752*1024,  16*1024,       UFS_PART_3},/* sensorhub       16M    p32*/
  {PART_BOOT_A,           768*1024,  32*1024,       UFS_PART_3},/* boot            32M    p33*/
  {PART_RECOVERY_A,       800*1024,  64*1024,       UFS_PART_3},/* recovery        64M    p34*/
  {PART_DTS_A,            864*1024,  16*1024,       UFS_PART_3},/* dtimage         16M    p35*/
  {PART_TRUSTFIRMWARE_A,  880*1024,  2*1024,        UFS_PART_3},/* trustfirmware   2M     p36*/
  {PART_MODEM_FW_A,       882*1024,  56*1024,       UFS_PART_3},/* modem_fw        56M    p37*/
  {PART_RESERVED4_A,      938*1024,  4*1024,       UFS_PART_3},/* reserved4A      4M    p38*/
  {PART_HDCP_A,      942*1024,  1*1024,       UFS_PART_3},/* PART_HDCP_A      1M    p39*/
  {PART_DDR_PARA_A,       943*1024,  1*1024,        UFS_PART_3},/* DDR_PARA        1M     p40*/
  {PART_MODEMNVM_UPDATE_A,944*1024,  16*1024,       UFS_PART_3},/* modemnvm update 16M    p41*/
  {PART_MODEMNVM_CUST_A,960*1024,  64*1024,       UFS_PART_3},/* modemnvm update cust 64M    p42*/
  {PART_PATCH_A,          1024*1024,  32*1024,       UFS_PART_3},/* patch           32M    p43*/
  {PART_VERSION_A,        1056*1024,  32*1024,        UFS_PART_3},/* version        24M     p44*/
  {PART_VENDOR_A,         1088*1024,  784*1024,      UFS_PART_3},/* vendor          784M   p45*/
  {PART_PRODUCT_A,        1872*1024, 192*1024,      UFS_PART_3},/* product         192M   p46*/
  {PART_CUST_A,           2064*1024, 192*1024,      UFS_PART_3},/* cust            192M   p47*/
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         2256*1024, 3552*1024,     UFS_PART_3},/* system          3552M  p48*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        5808*1024, 128*1024,       UFS_PART_3},/* reserved5       128M    p49*/
  {PART_HIBENCH_DATA,   5936*1024, 512*1024,       UFS_PART_3},/* hibench_data       512M    p50*/
  {PART_USERDATA,         6448*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p51*/
  #else
  {PART_USERDATA,         5808*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p49*/
  #endif
  #else
  {PART_SYSTEM_A,         2256*1024, 4688*1024,     UFS_PART_3},/* system          4688M  p48*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        6944*1024, 128*1024,       UFS_PART_3},/* reserved5       128M    p49*/
  {PART_HIBENCH_DATA,   7072*1024, 512*1024,       UFS_PART_3},/* hibench_data       512M    p50*/
  {PART_USERDATA,         7584*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p51*/
  #else
  {PART_USERDATA,         6944*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G    p49*/
  #endif
  #endif
  {"0", 0, 0, 0},
};
